        ...
        if (resource.spec.source.type === 'Git'){
          ...
          if (resource.spec.source.git.uri !== client.git.uri){
            ...
            if (!fs.existsSync(repositoryDir)) {
              ...
              util.execSync('git', ['fetch','--depth','1','--no-tags','--update-shallow','origin',`${branchName}`], {cwd:repositoryDir, encoding:'utf-8'})
          ...
          var gitRevParseResult = util.execSync('git', ['rev-parse', revParseRef], {cwd:repositoryDir, encoding:'utf-8'})
